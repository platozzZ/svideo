	...
	<view>
		...
		<view class="">
			<view class="u-tabs-box">
				<u-tabs activeColor="#f29100" :list="list" :is-scroll="false" :current="current" @change="change"></u-tabs>
			...
			<swiper class="swiper-box" :current="swiperCurrent" @transition="transition" @animationfinish="animationfinish" v-if="false">
